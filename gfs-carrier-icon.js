...
export class GfsCarrierIcon extends PolymerElement {
    static get template() {
        return html`
            <style>
                :host {
    ...
    _computeIcon(countryCode, providerName, iconSize) {
        const carrierLink = this.resolveUrl('//gfswidgetcdn.azurewebsites.net/images/widgets/carriers/');
...
window.customElements.define('gfs-carrier-icon', GfsCarrierIcon);
